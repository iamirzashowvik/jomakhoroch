...
class HishabMonthly extends StatefulWidget {
  final String totalSale, totalBaki;
  const HishabMonthly(this.totalSale, this.totalBaki);

  @override
  _HishabMonthlyState createState() => _HishabMonthlyState();
}

class _HishabMonthlyState extends State<HishabMonthly> {
  Widget partOne() {
    return Card(
      color: Colors.white,
      child: Padding(
