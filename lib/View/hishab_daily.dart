...
class HishabDaily extends StatefulWidget {
  final String totalSale, totalBaki;
  const HishabDaily(this.totalSale, this.totalBaki);

  @override
  _HishabDailyState createState() => _HishabDailyState();
}

class _HishabDailyState extends State<HishabDaily> {
  Widget partOne() {
    return Card(
      color: Colors.white,
      child: Padding(
