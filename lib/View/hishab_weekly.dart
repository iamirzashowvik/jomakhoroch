...
class HishabWeekly extends StatefulWidget {
  final String totalSale, totalBaki;
  const HishabWeekly(this.totalSale, this.totalBaki);

  @override
  _HishabWeeklyState createState() => _HishabWeeklyState();
}

class _HishabWeeklyState extends State<HishabWeekly> {
  Widget partOne() {
    return Card(
      color: Colors.white,
      child: Padding(
